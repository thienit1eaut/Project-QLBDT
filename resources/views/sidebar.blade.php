    ...
    <div class="card-body nav-control py-3 px-1">
        <ul class="nav flex-column">
            <li class="nav-item active">
                <a class="nav-link" href="#"><i class="fas fa-tachometer-alt mr-1"></i> Bảng điều khiển</a>
            </li>
            <li class="dropdown-divider"></li>
            <li class="nav-item">
                <a class="nav-link" href="#"><i class="fas fa-store mr-1"></i> Quản lý bán hàng</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#"><i class="fas fa-users mr-1"></i> Quản lý nhân viên</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#"><i class="fas fa-user mr-1"></i> Quản lý tài khoản</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#"><i class="fas fa-book mr-1"></i> Thống kê, báo cáo</a>
            </li>
        </ul>
    </div>
</div>