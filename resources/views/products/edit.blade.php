        ...
        <div class="row">
            ...
            <div class="col col-md-10">
                <div class="content-main">
                    <form action="{{ route('product.update', $dataitem->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="card mb-4">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-7 border-right">
                                                    ...
                                                    <div class="form-group form-check">
                                                        <input type="checkbox" class="form-check-input" id="checkbox_fields[84]" name="act" @checked($dataitem->act == 1)>
                                                        <label for="fields[84][]" class="form-check-label">Kích hoạt</label>
                                                    </div>
                                                </div>
                                                <div class="col-sm-5">
                                                    <div class="form-group">
                            ...
                            <div class="card-footer">
                                <a href="{{ route('product.edit', $dataitem->id) }}" class="btn btn-outline-secondary">Hủy</a>
